    ...
    <div className="min-h-screen mx-auto">
      ...
      <main className="bg-[#F5E6D3] min-h-screen pb-12">
        ...
        <div className="w-full max-w-[1280px] mx-auto px-8 pt-16 flex flex-col gap-6">
          <h1 className="font-bold text-[32px] leading-[100%] tracking-[0px] text-gray-900" style={{ fontFamily: 'var(--font-manrope)' }}>Privacy Policy</h1>
          
          <p className="text-gray-800 leading-relaxed">
            <span className="font-semibold">Last updated:</span> September 10, 2024
          </p>

          {/* Intro */}
          <p className="text-gray-800 leading-relaxed">
            This Privacy Policy describes how Raw Earth Crystals (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from rawearthcrystals.com.au (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
          </p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Changes to This Privacy Policy</h2>
            <p className="text-gray-800 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">How We Collect and Use Your Personal Information</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">What Personal Information We Collect</h2>
            <p className="text-gray-800 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Information We Collect Directly from You</h2>
            <p className="text-gray-800 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Information We Collect about Your Usage</h2>
            <p className="text-gray-800 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Information We Obtain from Third Parties</h2>
            <p className="text-gray-800 leading-relaxed mb-2">
          ...
          <section>
            ...
            <p className="text-gray-800 leading-relaxed mb-2">
              <span className="font-semibold">Security and Fraud Prevention.</span> We use your personal information to detect, investigate or take action regarding possible fraudulent, illegal or malicious activity. If you choose to use the Services and register an account, you are responsible for keeping your account credentials safe. We highly recommend that you do not share your username, password, or other access details with anyone else. If you believe your account has been compromised, please contact us immediately.
            </p>
            <p className="text-gray-800 leading-relaxed">
              <span className="font-semibold">Communicating with You and Service Improvement.</span> We use your personal information to provide you with customer support and improve our Services. This is in our legitimate interests in order to be responsive to you, to provide effective services to you, and to maintain our business relationship with you.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">How We Disclose Personal Information</h2>
            <p className="text-gray-800 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Third Party Websites and Links</h2>
            <p className="text-gray-800 leading-relaxed">
          ...
          {/* Children's Data */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Children's Data</h2>
            <p className="text-gray-800 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Security and Retention of Your Information</h2>
            <p className="text-gray-800 leading-relaxed mb-2">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-800 ml-4">
              <li><span className="font-semibold">Right to Access / Know:</span> You may have a right to request access to personal information that we hold about you, including details relating to the ways in which we use and share your information.</li>
              <li><span className="font-semibold">Right to Delete:</span> You may have a right to request that we delete personal information we maintain about you.</li>
              <li><span className="font-semibold">Right to Correct:</span> You may have a right to request that we correct inaccurate personal information we maintain about you.</li>
              <li><span className="font-semibold">Right of Portability:</span> You may have a right to receive a copy of the personal information we hold about you and to request that we transfer it to a third party, in certain circumstances and with certain exceptions.</li>
              <li><span className="font-semibold">Restriction of Processing:</span> You may have the right to ask us to stop or restrict our processing of personal information.</li>
              <li><span className="font-semibold">Withdrawal of Consent:</span> Where we rely on consent to process your personal information, you may have the right to withdraw this consent.</li>
              <li><span className="font-semibold">Appeal:</span> You may have a right to appeal our decision if we decline to process your request. You can do so by replying directly to our denial.</li>
              <li><span className="font-semibold">Managing Communication Preferences:</span> We may send you promotional emails, and you may opt out of receiving these at any time by using the unsubscribe option displayed in our emails to you. If you opt out, we may still send you non-promotional emails, such as those about your account or orders that you have made.</li>
            </ul>
            <p className="text-gray-800 leading-relaxed mt-2">
          ...
          {/* Complaints */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Complaints</h2>
            <p className="text-gray-800 leading-relaxed">
          ...
          {/* International Users */}
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">International Users</h2>
            <p className="text-gray-800 leading-relaxed mb-2">
          ...
          <section>
            ...
            <p className="text-gray-800 leading-relaxed">
              ...
              <a href="mailto:legal@rawearthcrystals.com.au" className="hover:underline">
                legal@rawearthcrystals.com.au
              </a>.
            </p>
          </section>
        </div>
