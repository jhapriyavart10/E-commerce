...
export default function SearchResultsPage() {
  ...
  const query = searchParams.get('q')?.toLowerCase() || ''; // Get the "turt" or query
  ...
  if (loading) return <div className="bg-[#F6D8AB] min-h-screen flex items-center justify-center font-lora">Searching...</div>;
