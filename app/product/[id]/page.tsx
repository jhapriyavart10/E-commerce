      ...
      <div className="max-w-[1440px] mx-auto px-6 py-8 md:px-8 md:py-8 lg:px-16">
        <div className="product-layout">
          ...
          <div className="flex-1 min-w-0 lg:pl-[91px]">
            ...
            {/* Quantity Selector */}
            <div style={{ border: '1px solid #280F0B', borderBottom: 'none', padding: '6px 8px', display: 'inline-flex', width: '116px', height: '38px', justifyContent: 'space-between', alignItems: 'center', marginBottom: 0, marginTop: 0, boxSizing: 'border-box' }}>
              <button
            ...
            <button
              ...
              className="w-full md:w-[565px] h-12 md:h-[51px] bg-[#7F3E2F] text-white font-semibold text-base px-10 py-[15px] flex items-center justify-center gap-3 border-0 cursor-pointer hover:opacity-90 transition-opacity mb-3"
            >
              ADD TO CART
            </button>
