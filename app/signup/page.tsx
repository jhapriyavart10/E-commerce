                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-8 gap-x-4 lg:gap-x-[16px]">
                  ...
                  {[
                    ...
                    <div key={field.label} className="relative group w-full">
                      ...
                      <span
                        className="absolute left-0 bottom-0 h-[1px] w-full bg-[#280F0B]/30
                  ...
                  <div className="relative group w-full">
                    ...
                    <span className="absolute left-0 bottom-0 w-full h-[1px] bg-[#280F0B]/30" />
                    <span className="absolute left-0 bottom-0 h-[1px] w-full bg-[#280F0B]/30 scale-x-0 origin-left transition-transform duration-300 peer-focus:scale-x-100 peer-focus:bg-[#280F0B]" />
                  </div>
