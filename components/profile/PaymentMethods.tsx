...
const PaymentMethods = () => {
  return (
    <div className="flex flex-col items-center text-center py-12 animate-in fade-in duration-500">
      ...
      <button className="bg-[#7F3E2F] text-[#FCF3E5] px-10 py-4 rounded-sm font-medium tracking-widest hover:bg-[#6D3A2D] transition-colors uppercase text-sm flex items-center gap-3">
        <Image 
